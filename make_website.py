...
def read_file(filename):
    ...
    # get the content of the file and write the content into the list
...
def get_name(resume_list):
    """
    Get the html name from the given list
    """
    
    #get the name from the given list
    name = resume_list[0]
...
def get_projects(resume_list):
    """
    Get project from the given list
    """
    # initlize the project list
    project_list = []
...
def get_courses(resume_list): 
    """
    Get course info from the given list
    """
...
def create_email_link(email_address):
    ...
    # insert code
    email = '<a href="mailto:' + email_address + '">' + email_address.replace('@', '[aT]') + '</a>'
